...
## Examples  
[JRPG Demo](/godot/jrpg-demo/index.html): Proof-of-concept for embedding a Godot game within an HTML5 page.

[Harambe](/godot/harambe/index.html): A basic, side-scrolling shooter game, based on the "Getting Started with Godot" tutorial linked above.

[Meatball](/godot/meatball/index.html): Another very simple game, ported from one of my first Monogame projects.
