...
<html>
    ...
    <body class="battlescribe">
        <div class="battlescribe">
            <h1>Tyranids 2k (Warhammer 40,000 8th Edition) [117 PL, 5CP, 2,000pts]</h1>
            <ul>
            <li class="force">
                <h2>Battalion Detachment +5CP (Tyranids) [117 PL, 5CP, 2,000pts]</h2>
                <ul>
                    <li class="category">
                        <h3>Configuration [8CP]</h3>
                        <ul>
                            ...
                            <li class="rootselection">
                                <h4>[Reference] Extensions of the Hive Mind</h4>
                                <p class="category-names">
                                    <span class="bold">Categories:</span> <span class="caps">Configuration</span>
                                </p>
                                <p class="rule-names">
                                    <span class="bold">Rules:</span> <span class="italic">Extensions of the Hive Mind</span>
                                </p>
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Extensions of the Hive Mind</span>
                                </p>
                                    <br>
                                    <table cellspacing="-1">
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="profile-name">Extensions of the Hive Mind</td>
                                            <td>If your army is Battle-forged, all Troops units in Tyranids Detachments gain this ability. Such a unit that is within range of an objective marker (as specified in the mission) controls the objective marker even if there are more enemy models within range of that objective marker. If an enemy unit within range of the same objective marker has a similar ability, then the objective marker is controlled by the player who has the most models within range of it as normal.</td>
                                            <td>
                                                Codex: Tyranids p116
                                            </td>
                                        </tr>
                    ...
                    <li class="category">
                        <h3>Stratagems [-3CP]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Bounty of the Hive Fleet [-3CP]</h4>
                                <p>
                                    <span class="bold">Selections:</span> 2 Extra Bio-artefacts [-3CP]
                                </p>
                                <p class="category-names">
                    ...
                    <li class="category">
                        ...
                        <ul>
                            ...
                            <li class="rootselection">
                                <h4>Hive Tyrant [11 PL, 233pts]</h4>
                                <p>
                                    <span class="bold">Selections:</span> Adrenal Glands [5pts], Heavy Venom Cannon [18pts], Monstrous Boneswords [20pts], Prehensile Pincer Tail, The Miasma Cannon, Wings [2 PL, 47pts]
                                </p>
                                <p class="category-names">
                                ...
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Adrenal Glands, Death Throes, Psychic Barrier, Shadow in the Warp, Swooping Assault, Synapse, The Miasma Cannon, The Will of the Hive Mind</span>, <span class="bold">Psyker:</span> <span class="italic">Hive Tyrant</span>, <span class="bold">Stat Damage - M, WS &amp; BS:</span> <span class="italic">Hive Tyrant with Wings (1), Hive Tyrant with Wings (2), Hive Tyrant with Wings (3)</span>, <span class="bold">Unit:</span> <span class="italic">Hive Tyrant</span>, <span class="bold">Weapon:</span> <span class="italic">Heavy Venom Cannon, Monstrous Boneswords, Prehensile Pincer Tail, The Miasma Cannon</span>
                                </p>
                                    <br>
                                    <table cellspacing="-1">
                                        <tr>
                                    ...
                                    <table cellspacing="-1">
                                        ...
                                        <tr>
                                            <td class="profile-name">Monstrous Boneswords</td>
                                            <td>Melee</td><td>Melee</td><td>User</td><td>-2</td><td>3</td><td>A model armed with monstrous boneswords can make 1 additional attack with them in the Fight phase.</td>
                                            <td>
                                                Codex: Tyranids p111
                                            </td>
                                        </tr>
                    ...
                    <li class="category">
                        <h3>Troops [52 PL, 811pts]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Genestealers [16 PL, 240pts]</h4>
                                <p>
                                    <span class="bold">Selections:</span> 20x Scything Talons
                                </p>
                                <p class="category-names">
                                    <span class="bold">Categories:</span> <span class="caps">Faction: &lt;Hive Fleet&gt;, Faction: Tyranids, Infantry, Genestealer, Troops</span>
                                </p>
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Flurry of Claws, Infestation, Lightning Reflexes, Swift and Deadly</span>, <span class="bold">Weapon:</span> <span class="italic">Scything Talons</span>
                                </p>
                                <ul>
                                    <li>
                            ...
                            <li class="rootselection">
                                <h4>Hormagaunts [6 PL, 96pts]</h4>
                                <p>
                                    <span class="bold">Selections:</span> Adrenal Glands [16pts]
                                </p>
                                <p class="category-names">
                                    <span class="bold">Categories:</span> <span class="caps">Faction: &lt;Hive Fleet&gt;, Faction: Tyranids, Troops, Infantry</span>
                                </p>
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Adrenal Glands, Bounding Leap, Hungering Swarm, Instinctive Behaviour</span>
                                </p>
                                <ul>
                                    <li>
                                        <h4>16x Hormagaunt [80pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 16x Scything Talons
                                        </p>
                                        <p class="profile-names">
                                            <span class="bold">Unit:</span> <span class="italic">Hormagaunt</span>, <span class="bold">Weapon:</span> <span class="italic">Scything Talons</span>
                                        </p>
                                    ...
                                    <table cellspacing="-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>Whenever this unit piles in and consolidates, it can move up to 6".</td>
                                            <td>
                                                Codex: Tyranids p90
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="profile-name">Hungering Swarm</td>
                                            <td>If this unit contains 20 or more models, you can re-roll wound rolls of 1 when it fights.</td>
                                            <td>
                                                Codex: Tyranids p90
                                            </td>
                                        </tr>
                                    ...
                                    <table cellspacing="-1">
                                        ...
                                        <tr>
                                            ...
                                            <td>8"</td><td>4+</td><td>4+</td><td>3</td><td>3</td><td>1</td><td>2</td><td>5</td><td>6+</td>
                                            <td>
                                                Codex: Tyranids p90
                                            </td>
                                        </tr>
                            ...
                            <li class="rootselection">
                                ...
                                <ul>
                                    <li>
                                        <h4>10x Termagant (Devourer) [80pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 10x Devourer [40pts]
                                        </p>
                                        <p class="profile-names">
                                    ...
                                    <li>
                                        <h4>20x Termagant (Fleshborer) [80pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 20x Fleshborer
                                        </p>
                                        <p class="profile-names">
                            ...
                            <li class="rootselection">
                                <h4>Tyranid Warriors [5 PL, 75pts]</h4>
                                <p class="category-names">
                    ...
                    <li class="category">
                        <h3>Elites [13 PL, 258pts]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Hive Guard [13 PL, 258pts]</h4>
                                <p class="category-names">
                                ...
                                <ul>
                                    <li>
                                        <h4>6x Hive Guard (Impaler) [258pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 6x Impaler Cannon [150pts]
                                        </p>
                                        <p class="profile-names">
                    ...
                    <li class="category">
                        <h3>Heavy Support [18 PL, 333pts]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Carnifexes [18 PL, 333pts]</h4>
                                <p class="category-names">
                                ...
                                <ul>
                                    <li>
                                        <h4>Carnifex [111pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> Adrenal Glands [5pts], Bone Mace [2pts], Chitin Thorns [5pts], Heavy Venom Cannon [18pts], Monstrous Scything Talons [14pts]
                                        </p>
                                        <p class="profile-names">
                                            <span class="bold">Abilities:</span> <span class="italic">Adrenal Glands, Chitin Thorns</span>, <span class="bold">Unit:</span> <span class="italic">Carnifex</span>, <span class="bold">Weapon:</span> <span class="italic">Bone Mace, Heavy Venom Cannon, Monstrous Scything Talons</span>
                                        </p>
                                    ...
                                    <table cellspacing="-1">
                                        ...
                                        <tr>
                                            <td class="profile-name">Chitin Thorns</td>
                                            <td>At the end of the Fight phase, roll a D6 for each enemy unit within 1" of any models with chitin thorns. On a 6, that unit suffers a mortal wound.</td>
                                            <td>
                                                Codex: Tyranids p102
                                            </td>
                                        </tr>
            ...
            <div class="summary">
                ...
                <p>
                    <span class="bold">Extensions of the Hive Mind:</span>
