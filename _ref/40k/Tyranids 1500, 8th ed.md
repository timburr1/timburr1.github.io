...
<html>
    ...
    <body class="battlescribe">
        <div class="battlescribe">
            <h1>Tyranids 2k (Warhammer 40,000 8th Edition) [96 PL, 5CP, 1,499pts]</h1>
            <ul>
            <li class="force">
                <h2>Battalion Detachment +5CP (Tyranids) [96 PL, 5CP, 1,499pts]</h2>
                <ul>
                    <li class="category">
                    ...
                    <li class="category">
                        ...
                        <ul>
                            ...
                            <li class="rootselection">
                                ...
                                <p>
                                    <span class="bold">Selections:</span> 3. Tenacious Survivor, Adrenal Glands [5pts], Heavy Venom Cannon [18pts], Monstrous Boneswords [20pts], Prehensile Pincer Tail, The Miasma Cannon, Warlord, Wings [2 PL, 47pts]
                                </p>
                                <p class="category-names">
                    ...
                    <li class="category">
                        ...
                        <ul>
                            ...
                            <li class="rootselection">
                                ...
                                <p>
                                    <span class="bold">Selections:</span> 18x Scything Talons
                                </p>
                                <p class="category-names">
                                    <span class="bold">Categories:</span> <span class="caps">Faction: &lt;Hive Fleet&gt;, Faction: Tyranids, Infantry, Genestealer, Troops</span>
                                </p>
                    ...
                    <li class="category">
                        <h3>Elites [13 PL, 172pts]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Hive Guard [13 PL, 172pts]</h4>
                                <p class="category-names">
                                ...
                                <ul>
                                    <li>
                                        <h4>4x Hive Guard (Impaler) [172pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 4x Impaler Cannon [100pts]
                                        </p>
                                        <p class="profile-names">
                    ...
                    <li class="category">
                        <h3>Heavy Support [18 PL, 318pts]</h3>
                        <ul>
                            <li class="rootselection">
