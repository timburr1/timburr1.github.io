...
<html>
    ...
    <body class="battlescribe">
        <div class="battlescribe">
            <h1>Tyranids_2k (Warhammer 40,000 9th Edition) [108 PL, 11CP, 2,000pts]</h1>
            <ul>
            <li class="force">
                <h2>Battalion Detachment 0CP (Tyranids) [108 PL, 11CP, 2,000pts]</h2>
                <ul>
                    <li class="category">
                    ...
                    <li class="category">
                        ...
                        <ul>
                            ...
                            <li class="rootselection">
                                <h4>The Swarmlord [14 PL, 270pts]</h4>
                                <p>
                                    <span class="bold">Selections:</span> Bone Sabres, Power: Smite, Prehensile Pincer Tail
                                </p>
                                <p class="category-names">
                                ...
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Blade Parry, Death Throes, Hive Commander, Psychic Barrier, Shadow in the Warp, Synapse, The Will of the Hive Mind</span>, <span class="bold">Psychic Power:</span> <span class="italic">Smite</span>, <span class="bold">Psyker:</span> <span class="italic">The Swarmlord</span>, <span class="bold">Stat Damage - M, S &amp; A:</span> <span class="italic">The Swarmlord (1), The Swarmlord (2), The Swarmlord (3)</span>, <span class="bold">Unit:</span> <span class="italic">The Swarmlord</span>, <span class="bold">Weapon:</span> <span class="italic">Bone Sabres, Prehensile Pincer Tail</span>
                                </p>
                                    <br>
                                    <table cellspacing="-1">
                                        <tr>
                    ...
                    <li class="category">
                        <h3>Troops [45 PL, 850pts]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Genestealers [16 PL, 300pts]</h4>
                                <p>
                                ...
                                <ul>
                                    <li>
                                        <h4>20x Genestealer [300pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 20x Rending Claws
                                        </p>
                                        <p class="profile-names">
                            ...
                            <li class="rootselection">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <h4>23x Termagant (Fleshborer) [115pts]</h4>
                                        <p>
                                            <span class="bold">Selections:</span> 23x Fleshborer
                                        </p>
                                        <p class="profile-names">
                    ...
                    <li class="category">
                        <h3>Heavy Support [18 PL, 315pts]</h3>
                        <ul>
                            <li class="rootselection">
                                <h4>Carnifexes [18 PL, 315pts]</h4>
                                <p class="category-names">
