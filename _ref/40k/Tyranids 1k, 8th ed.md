...
<html>
    ...
    <body class="battlescribe">
        <div class="battlescribe">
            <h1>Tyranids 1k (Warhammer 40,000 8th Edition) [62 PL, 5CP, 1,000pts]</h1>
            <ul>
            <li class="force">
                <h2>Battalion Detachment +5CP (Tyranids) [62 PL, 5CP, 1,000pts]</h2>
                <ul>
                    <li class="category">
                    ...
                    <li class="category">
                        ...
                        <ul>
                            <li class="rootselection">
                                ...
                                <p>
                                    <span class="bold">Selections:</span> Chameleonic Mutation, Monstrous Rending Claws, Power: Synaptic Lure
                                </p>
                                <p class="category-names">
                                ...
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Brood Telepathy, Chameleonic Mutation, Lightning Reflexes, Shadow in the Warp, Swift and Deadly, Synapse</span>, <span class="bold">Psychic Power:</span> <span class="italic">Synaptic Lure</span>, <span class="bold">Psyker:</span> <span class="italic">Broodlord</span>, <span class="bold">Unit:</span> <span class="italic">Broodlord</span>, <span class="bold">Weapon:</span> <span class="italic">Monstrous Rending Claws</span>
                                </p>
                                    <br>
                                    <table cellspacing="-1">
                                        <tr>
                            ...
                            <li class="rootselection">
                                ...
                                <p>
                                    <span class="bold">Selections:</span> Adrenal Glands [5pts], Heavy Venom Cannon [18pts], Monstrous Boneswords [20pts], Power: Catalyst, Power: Psychic Scream, Prehensile Pincer Tail, The Miasma Cannon, Wings [2 PL, 47pts]
                                </p>
                                <p class="category-names">
                                ...
                                <p class="profile-names">
                                    <span class="bold">Abilities:</span> <span class="italic">Adrenal Glands, Death Throes, Psychic Barrier, Shadow in the Warp, Swooping Assault, Synapse, The Miasma Cannon, The Will of the Hive Mind</span>, <span class="bold">Psychic Power:</span> <span class="italic">Catalyst, Psychic Scream</span>, <span class="bold">Psyker:</span> <span class="italic">Hive Tyrant</span>, <span class="bold">Stat Damage - M, WS &amp; BS:</span> <span class="italic">Hive Tyrant with Wings (1), Hive Tyrant with Wings (2), Hive Tyrant with Wings (3)</span>, <span class="bold">Unit:</span> <span class="italic">Hive Tyrant</span>, <span class="bold">Weapon:</span> <span class="italic">Heavy Venom Cannon, Monstrous Boneswords, Prehensile Pincer Tail, The Miasma Cannon</span>
                                </p>
                                    <br>
                                    <table cellspacing="-1">
                                        <tr>
